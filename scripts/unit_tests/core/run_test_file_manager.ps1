# FileManager类测试脚本
# 用途：编译并运行FileManager测试程序

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  FileManager Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($gppCheck) {
    ...
    & g++ -std=c++17 -Wall -I"$projectRoot\include" "$testFile" "$fileManagerCpp" -o "$outputExe" 2>&1 | Write-Host
...
$testResult = & .\test_file_manager.exe 2>&1
