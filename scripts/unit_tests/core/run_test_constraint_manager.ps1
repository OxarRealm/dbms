# 约束管理器测试脚本
# 用途：编译并运行ConstraintManager测试程序

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Constraint Manager Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$testFile = Join-Path $testDir "test_constraint_manager.cpp"
$constraintManagerCpp = Join-Path $projectRoot "src\core\constraint_manager.cpp"
...
$outputExe = Join-Path $outputDir "test_constraint_manager.exe"
...
$testResult = & .\test_constraint_manager.exe 2>&1
