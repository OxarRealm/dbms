# SQL WHERE条件解析器测试脚本
# 用途：编译并运行Parser WHERE条件解析测试程序

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  SQL WHERE Parser Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$testFile = Join-Path $testDir "test_parser_where.cpp"
...
$outputExe = Join-Path $outputDir "test_parser_where.exe"
...
$testResult = & .\test_parser_where.exe 2>&1
