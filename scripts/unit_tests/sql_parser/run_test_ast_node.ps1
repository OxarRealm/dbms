# AST Node模块测试脚本
# 用途：编译并运行AST Node测试程序

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  AST Node Module Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($gppCheck) {
    ...
    & g++ -std=c++17 -Wall -I"$projectRoot\include" "$testFile" "$astNodeCpp" -o "$outputExe" 2>&1 | Write-Host
...
$testResult = & .\test_ast_node.exe 2>&1
