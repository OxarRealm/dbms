# DataManager类测试脚本
# 用途：编译并运行DataManager测试程序

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  DataManager Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($gppCheck) {
    ...
    & g++ -std=c++17 -Wall -I"$projectRoot\include" "$testFile" "$dataManagerCpp" -o "$outputExe" 2>&1 | Write-Host
...
$testResult = & .\test_data_manager.exe 2>&1
